...
@include('includes.DashboardMessages')
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="adv-table">
                                    <table class="display table table-bordered table-striped" id="listPermissions">
                                        <thead>
                                        <tr>
                                            <th>Role</th>
                                            <th>Status</th>
...
@foreach($Permissions as $permission)
                                            <tr>
                                                ...
                                                !!}</td>
                                                <td class="text-center"><a href="/Admin/editPermission/{{{ $permission->permission_id }}}" class="btn btn-primary">Edit</a></td>
                                            </tr>
@endforeach
                                        </tbody>
                                    </table>
